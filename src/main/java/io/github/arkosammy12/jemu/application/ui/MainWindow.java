...
import io.github.arkosammy12.jemu.application.ui.debugger.DebuggerPanel;
import io.github.arkosammy12.jemu.application.ui.util.ToggleableSplitPane;
import io.github.arkosammy12.jemu.application.ui.util.WindowTitleManager;
import io.github.arkosammy12.jemu.application.ui.video.DisplayRenderer;
...
public class MainWindow extends JFrame implements EmulatorInitializerConsumer, Closeable {
    ...
    public VideoDriver getVideoDriver() {
        return this.leftPanel.getEmulatorViewport().getDisplayRenderer();
    }
