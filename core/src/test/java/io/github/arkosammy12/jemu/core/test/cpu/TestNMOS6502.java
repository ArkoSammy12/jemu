...
public class TestNMOS6502 extends NMOS6502 {

    public TestNMOS6502(SystemBus systemBus) {
        super(systemBus);
    }

    public void acceptTestCase(NMOS6502TestCase testCase) {

        NMOS6502TestState initialState = testCase.getInitialState();
