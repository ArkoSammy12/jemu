...
public final class SystemSettingsElementBuilderCollector implements SystemSettingsBuilder {
    ...
    public SystemSettingsBuilder addSection(String name, Consumer<SystemSettingsBuilder> sectionBuilder) {
        SystemSettingSectionBuilder section = new SystemSettingSectionBuilder(name);
    ...
    List<SystemSettingElement> build() {
